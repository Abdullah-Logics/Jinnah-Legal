  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 rounded-2xl p-6 text-white">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div className="relative">
            ...
            <button className="absolute bottom-0 right-0 p-2 bg-white text-emerald-600 rounded-full"><Camera size={16} /></button>
          </div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        ...
        {isEditing && (
          <button onClick={handleSave} className="mt-6 flex items-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-xl font-semibold">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
        ...
        <div className="p-4 bg-emerald-50 rounded-xl">
          ...
          <button className="mt-4 px-4 py-2 bg-emerald-600 text-white rounded-lg font-medium">Upgrade Plan</button>
        </div>
      </div>
    </div>
  );
